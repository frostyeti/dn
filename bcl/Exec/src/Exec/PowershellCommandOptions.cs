...
/// <summary>
/// Represents PowerShell command options for executing PowerShell scripts or
/// commands. It inherits from <see cref="ShellCommandOptions"/>
/// and <see cref="CommandOptions"/>.
/// </summary>
public sealed class PowershellCommandOptions : ShellCommandOptions
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PowershellCommandOptions"/> class with default settings for PowerShell execution.
    /// </summary>
    public PowershellCommandOptions()
    {
        this.File = "powershell";

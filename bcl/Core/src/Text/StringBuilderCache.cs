...
public static class StringBuilderCache
{
    ...
    /// <remarks>
    /// <para>If a StringBuilder of an appropriate size is cached, it will be returned and the cache emptied.</para>
    /// <example>
    /// <code lang="csharp">
    ...
    /// <summary>Places the specified builder in the cache if it is not too big.</summary>

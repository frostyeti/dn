    ...
    where TKey : notnull
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Map{TKey, TValue}"/> class with the specified capacity.
    /// </summary>
    /// <param name="capacity">The initial capacity.</param>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// var map = new Map&lt;int, string&gt;(100);
    /// Assert.Empty(map);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Map{TKey, TValue}"/> class from a dictionary.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Map{TKey, TValue}"/> class from a dictionary with a custom comparer.
    /// </summary>
    /// <param name="dictionary">The dictionary to copy from.</param>
    ...
    /// var map = new Map&lt;string, int&gt;(dict, StringComparer.OrdinalIgnoreCase);
    /// Assert.Single(map);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Map{TKey, TValue}"/> class from a collection of tuples.
    /// </summary>
    ...
    /// var map = new Map&lt;int, string&gt;(items);
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Map{TKey, TValue}"/> class from a collection of key-value pairs.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Map{TKey, TValue}"/> class from a collection of key-value pairs with a custom comparer.
    /// </summary>
    /// <param name="collection">The collection of key-value pairs.</param>
    /// <param name="comparer">The key comparer to use.</param>
    /// <remarks>
    ...
    /// var map = new Map&lt;string, int&gt;(items, StringComparer.OrdinalIgnoreCase);
    /// Assert.Single(map);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Map{TKey, TValue}"/> class with a custom comparer.
    /// </summary>
    /// <param name="comparer">The key comparer to use.</param>
    /// <remarks>
    /// <example>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Map{TKey, TValue}"/> class with capacity and custom comparer.
    /// </summary>
    /// <param name="capacity">The initial capacity.</param>
    /// <param name="comparer">The key comparer to use.</param>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// var map = new Map&lt;int, string&gt;(100, EqualityComparer&lt;int&gt;.Default);
    /// Assert.Empty(map);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// var map = new Map&lt;int, string&gt;().Add((1, "one")).Add((2, "two"));
    /// Assert.Equal(2, map.Count);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// var map = new Map&lt;int, string&gt;().AddRange(new[] { (1, "one"), (2, "two") });
    /// Assert.Equal(2, map.Count);
    /// </code>
    /// </example>
    /// </remarks>

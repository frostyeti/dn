...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderedMap{TValue}"/> class.
    /// </summary>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderedMap{TValue}"/> class with the specified capacity.
    /// </summary>
    /// <param name="capacity">The initial capacity.</param>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// var map = new OrderedMap&lt;int&gt;(100);
    /// Assert.Empty(map);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderedMap{TValue}"/> class from a dictionary.
    /// </summary>
    ...
    /// var map = new OrderedMap&lt;int&gt;(dict);
    /// Assert.Single(map);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderedMap{TValue}"/> class from a dictionary with a custom comparer.
    /// </summary>
    /// <param name="dictionary">The dictionary to copy from.</param>
    ...
    /// <code lang="csharp">
    /// var dict = new Dictionary&lt;string, int&gt; { ["key"] = 42 };
    /// var map = new OrderedMap&lt;int&gt;(dict, StringComparer.Ordinal);
    /// Assert.Single(map);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderedMap{TValue}"/> class from a collection of tuples.
    /// </summary>
    ...
    /// var map = new OrderedMap&lt;int&gt;(items);
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderedMap{TValue}"/> class from a collection of tuples with a custom comparer.
    /// </summary>
    /// <param name="collection">The collection of key-value tuples.</param>
    /// <param name="comparer">The string comparer to use.</param>
    /// <remarks>
    ...
    /// var map = new OrderedMap&lt;int&gt;(items, StringComparer.Ordinal);
    /// Assert.Single(map);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderedMap{TValue}"/> class from a collection of key-value pairs.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderedMap{TValue}"/> class from a collection of key-value pairs with a custom comparer.
    /// </summary>
    /// <param name="collection">The collection of key-value pairs.</param>
    /// <param name="comparer">The string comparer to use.</param>
    /// <remarks>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderedMap{TValue}"/> class with a custom comparer.
    /// </summary>
    /// <param name="comparer">The string comparer to use.</param>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// var map = new OrderedMap&lt;int&gt;(StringComparer.Ordinal);
    /// map["key"] = 42;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OrderedMap{TValue}"/> class with capacity and custom comparer.
    /// </summary>
    /// <param name="capacity">The initial capacity.</param>
    /// <param name="comparer">The string comparer to use.</param>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// var map = new OrderedMap&lt;int&gt;(100, StringComparer.Ordinal);
    /// Assert.Empty(map);
    /// </code>
    /// </example>
    /// </remarks>

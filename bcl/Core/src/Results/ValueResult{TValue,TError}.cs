...
/// <example>
/// <code lang="csharp">
/// ValueResult&lt;int, string&gt; ok = ValueResult&lt;int, string&gt;.Ok(42);
/// ValueResult&lt;int, string&gt; failed = ValueResult&lt;int, string&gt;.Fail("failed");
/// </code>
/// </example>
/// </remarks>
    ...
    where TError : notnull
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ValueResult{TValue, TError}"/> struct using the default value for <typeparamref name="TValue"/>.
    /// </summary>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// var result = new ValueResult&lt;string, string&gt;();
    ...
    /// </summary>
    /// <param name="result">The value result to wrap.</param>
    /// <returns>A completed task containing <paramref name="result"/>.</returns>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// ValueResult&lt;int, string&gt; result = ValueResult&lt;int, string&gt;.Ok(42);
    /// Task&lt;ValueResult&lt;int, string&gt;&gt; task = result;
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <code lang="csharp">
    /// ValueResult&lt;int, string&gt; result = ValueResult&lt;int, string&gt;.Ok(42);
    /// ValueTask&lt;ValueResult&lt;int, string&gt;&gt; task = result;
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// ValueResult&lt;int, string&gt; result = ValueResult&lt;int, string&gt;.Fail("failed");
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// int hash = ValueResult&lt;int, string&gt;.Ok(42).GetHashCode();
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// bool equal = ValueResult&lt;int, string&gt;.Ok(42).Equals((object)ValueResult&lt;int, string&gt;.Ok(42));
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// IValueResult&lt;int, string&gt; other = ValueResult&lt;int, string&gt;.Ok(42);
    /// bool equal = ValueResult&lt;int, string&gt;.Ok(42).Equals(other);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// bool equal = ValueResult&lt;int, string&gt;.Ok(42).Equals(ValueResult&lt;int, string&gt;.Ok(42));
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// ValueResult&lt;int, string&gt;.Ok(42).Inspect(value => Console.WriteLine(value));
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// </summary>
    /// <param name="action">The action to execute for the error value.</param>
    /// <returns>The current value result.</returns>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// ValueResult&lt;int, string&gt;.Fail("failed").InspectError(error => Console.WriteLine(error));
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// bool matches = ValueResult&lt;int, string&gt;.Ok(42).IsOkAnd(value => value &gt; 0);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// bool matches = ValueResult&lt;int, string&gt;.Fail("failed").IsErrorAnd(error => error == "failed");
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <summary>
    /// Maps the success value to another success type.
    /// </summary>
    ...
    /// <example>
    /// <code lang="csharp">
    /// ValueResult&lt;string, string&gt; mapped = ValueResult&lt;int, string&gt;.Ok(42)
    ...
    /// <example>
    /// <code lang="csharp">
    /// ValueResult&lt;string, int&gt; mapped = ValueResult&lt;int, string&gt;.Fail("failed")
    ...
    /// <example>
    /// <code lang="csharp">
    /// ValueResult&lt;int, string&gt; result = ValueResult&lt;int, string&gt;.Fail("failed").Or(42);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// int value = ValueResult&lt;int, string&gt;.Fail("failed").OrDefault(0);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <example>
    /// <code lang="csharp">
    /// ValueResult&lt;int, string&gt; result = ValueResult&lt;int, string&gt;.Ok(42).OrError("forced");
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// </summary>
    /// <param name="other">The fallback error value.</param>
    /// <returns>The error value when available; otherwise <paramref name="other"/>.</returns>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// string error = ValueResult&lt;int, string&gt;.Ok(42).OrErrorDefault("fallback");
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <returns>The error value when available; otherwise the fallback error value.</returns>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// string error = ValueResult&lt;int, string&gt;.Ok(42).OrErrorDefault(() => "fallback");
    ...
    /// <example>
    /// <code lang="csharp">
    /// bool hasValue = ValueResult&lt;int, string&gt;.Ok(42).TryGetValue(out int? value);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// </summary>
    /// <param name="error">When this method returns, contains the error value if present; otherwise <see langword="null"/>.</param>
    /// <returns><see langword="true"/> when the value result is failed; otherwise <see langword="false"/>.</returns>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// bool hasError = ValueResult&lt;int, string&gt;.Fail("failed").TryGetError(out string? error);
    /// </code>
    /// </example>
    /// </remarks>

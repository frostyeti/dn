...
/// <summary>
/// Provides a low-level API for interacting with the Linux secret service using libsecret.
/// </summary>
/// <remarks>
/// <example>
/// <code lang="csharp">
/// LibSecret.SetSecret("MyService", "MyAccount", "MySecret");
/// </code>
/// </example>
/// </remarks>
...
public static class LibSecret
{
    ...
    /// <example>
    /// <code lang="csharp">
    /// LibSecret.DeleteSecret("MyService", "MyAccount");
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <returns>True if the secret was set, otherwise false.</returns>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// LibSecret.SetSecret("MyService", "MyAccount", "MySecret");
    ...
    /// <example>
    /// <code lang="csharp">
    /// LibSecret.SetSecret("MyService", "MyAccount", new byte[] { 1, 2, 3 });
    /// </code>
    /// </example>
    /// </remarks>
    [SupportedOSPlatform("linux")]
    ...
    /// <summary>
    /// Gets a secret from the Linux secret service as a string.
    /// </summary>
    /// <param name="service">The name of the service.</param>
    /// <param name="account">The account name.</param>
    ...
    /// <example>
    /// <code lang="csharp">
    /// var secret = LibSecret.GetSecret("MyService", "MyAccount");
    /// </code>
    /// </example>
    /// </remarks>
    [SupportedOSPlatform("linux")]
    ...
    /// <example>
    /// <code lang="csharp">
    /// var secretBytes = LibSecret.GetSecretAsBytes("MyService", "MyAccount");
    /// </code>
    /// </example>
    /// </remarks>
    [SupportedOSPlatform("linux")]
    ...
    /// <summary>
    /// Lists all secrets for a given service from the Linux secret service.
    /// </summary>
    /// <param name="service">The name of the service.</param>
    /// <returns>A list of <see cref="LibSecretRecord"/> instances.</returns>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// var secrets = LibSecret.ListSecrets("MyService");
    /// </code>
    /// </example>
    /// </remarks>
    [SupportedOSPlatform("linux")]

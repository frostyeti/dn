...
namespace FrostYeti.Crypto
{
        ...
        IComparable<MemoryProtectedText>
    {
        ...
        {
            this.encoding = EncryptionUtil.DefaultEncoding;
            this.Length = 0;
        }

        public MemoryProtectedText(SecureString secureString)
            : this(secureString, EncryptionUtil.DefaultEncoding)
        {
        }

        public MemoryProtectedText(string value)
            : this(value, EncryptionUtil.DefaultEncoding)
        {
        }
        ...
        public ReadOnlySpan<char> ToCharSpan()
            => this.ToCharSpan(EncryptionUtil.DefaultEncoding);
        ...
        public string ToString(bool unprotect)
            => this.ToString(unprotect, EncryptionUtil.DefaultEncoding);
